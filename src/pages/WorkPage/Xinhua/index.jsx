...
export default class Xinhua extends Component {
  ...
  render() {
    ...
    return (
      <div className="project-page-content">
      	<div className="hero-image" id="zoom-hero-image">
        ...
        <div className="summary" id="zoom-summary">
        ...
        <div className="divider-photo">
          <img src="https://rfarn.com/media/zoom3.png" alt=""/>
        </div>
        ...
        <div className="process-section will-fade fade appear">
          ...
          <div className="insight">
            <div className="insight-label zoom-insight-label">
              设计反馈
            </div>
        ...
        <div className="features will-fade fade appear">
          ...
          <div className="feature-info-left">
            ...
            <div className="feature-text feature-text-left zoom-feature">
          ...
          <div className="feature-info-right">
            <div className="feature-text feature-text-right zoom-feature">
        ...
        <div className="reflection-container" id="zoom-reflection">
          <div className="reflection">
            <h2>Reflection</h2>
            <div className="reflection-text">
              <h1>A product for users</h1>
              <p>
                This project was heavily focused on the development of a viable
                digital service. Our process incorporated a number of business
                considerations and approaches, but not enough attention to the
                user. I would have liked to spend more time focused on the
                audience of dating app users and researching their experiences
                to better identify needs and problems.
              </p>
              <p>
                Through this process, I was able to gain insight on the steps
                needed to transition an idea into a product with competitive
                edge, a market and profits. However, I also realized the need to
                constantly consider the user and keep sight of the original goal
                of creating a service for users.
              </p>
            </div>
          </div>
        </div>
